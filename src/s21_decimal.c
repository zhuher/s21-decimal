...
int s21_mul(s21_decimal v1, s21_decimal v2, s21_decimal *result) {
  ...
  uint32_t rval = OK;
  s21_mul_intfield(v1_double_mantissa, v2_double_mantissa, res_double_mantissa,
...
int s21_div(s21_decimal v1, s21_decimal v2, s21_decimal *result) {
  memset(result, 0, sizeof(result->bits));
  int32_t rval = OK;
  if (s21_is_intfield_zero(v2.bits, S21_MANTISSA_SIZE))
    rval = ZERO_DIVIDING;
  else {
    int16_t v1_exp = s21_get_exponent(v1), v2_exp = s21_get_exponent(v2),
            res_exp = 0;
...
int s21_from_decimal_to_float(s21_decimal src, float *dst) {
  char str[200] = {0};
  s21_dtoa(src.bits, s21_get_exponent(src), S21_MANTISSA_SIZE, (uint8_t *)str);
